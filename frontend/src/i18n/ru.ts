export default {
  ...
  project_add_info:
    'Объект добавлен в подборку «ss»! Загляните в раздел «Мои подборки», чтобы посмотреть все сохранённые объекты и собрать из них предложение для своего клиента.',
