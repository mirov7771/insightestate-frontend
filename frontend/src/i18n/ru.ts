export default {
  ...
  ai_header_1:
      '2. ИИ-подборщик проанализирует нашу базу и покажет подходящие варианты.',
  ai_header_2:
      '3. Понравившиеся объекты можно сразу добавить в подборки',
  ai_body:
  ...
  deleteProfileMessage: 'Если вы удалите профиль, восстановить его будет уже невозможно — все данные и подборки исчезнут навсегда. Пожалуйста, убедитесь, что вы точно хотите это сделать.',
