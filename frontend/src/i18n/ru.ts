export default {
  ...
  profit_description: 'При расчете показателей IRR, ROI, Cap Rate приводятся максимальные показатели в разрезе типов юнитов в рамках проекта, которые посчитаны на основании нашего прогноза потенциального дохода с аренды по средним значениям площади и стоимости. В расчете заложен 10 летний сценарий владения недвижимости собственником с последующей продажей на 10 год по оценочной рыночной стоимостью.',
  ...
  current_price: 'Цены актуальны на',

  current_price_description: 'Цены мы проверяем и актуализируем ежедневно на основе данных от застройщиков. Эти данные они обновляют раз в 2-3 недели.',
