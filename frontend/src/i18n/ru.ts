export default {
  ...
  deleteProfile: 'Вы уверены что хотите удалить профиль?',
  deleteProfileMessage:
    'Если вы удалите профиль, восстановить его будет уже невозможно — все данные и подборки исчезнут навсегда. Пожалуйста, убедитесь, что вы точно хотите это сделать.',
