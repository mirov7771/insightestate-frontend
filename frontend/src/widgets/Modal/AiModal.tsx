            ...
            <Spacer width="100%" height={8} />
            {
              !isNew ?
                  ...
                  <BaseField
                      ...
                      rows={7}
                      multiline={true}
                      label="Напишите пожелания вашего клиента: количество спален, бюджет, наличие спортзала, бассейна или УК, время до пляжа и любые другие детали которые помогут сделать точную подборку"
                  />
            }
          </StyledWrapperProgress>
        </StyledUpperWrapperProgress>
