    ...
    <div className={styles.developer}>
      <div className={styles.developer__top}>
        ...
        <div className={styles.developer__tags}>
          <span className={`${styles.developer__tag} ${eiaEnabled ? styles.developer__tag_green : styles.developer__tag_grey}`}>
            {eiaEnabled ?
              <IconCheck /> :
                <IconX/>
            }
          ...
          <span className={`${styles.developer__tag} ${landPurchased ? styles.developer__tag_green : styles.developer__tag_grey}`}>
            {landPurchased ?
              <IconCheck /> :
                <IconX />
            }
          ...
          <div className={styles.developer__percentages_line}>
            {unitCount?.sailed && unitCount?.total ?
                <div className={styles.developer__percentages_item}>
                  <Text variant="heading3">{((unitCount?.sailed / unitCount?.total) * 100).toFixed()}%</Text>
