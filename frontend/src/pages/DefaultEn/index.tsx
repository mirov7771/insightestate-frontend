      ...
      <div className="page-wrapper-updt">
        ...
        {showCookies ? (
          <div fs-cc="banner" className="flowappz-cookie-consent is-v3">
            <h5 className="cookie-heading-2 is-v3 text-size-body-2-cc">We use cookies</h5>
              ...
              <div className="container-main-cc">
                <div className="w-layout-grid features_cc_content-layout gap-0">
                  <div className="features_cc_content agent-page">
                    <div>
                      <div className="heading-style-h7-cc mb-8">Designed for Agents</div>
                      <p className="text-size-body-3-cc">Everything you need. Nothing you don’t</p>
                    </div>
                    <div>
                      <div className="text-size-body-2-cc is-opacity-64 mb-8 mob-size-16">
                        No more endless chats, outdated folders, manual updates, or chasing
                        developers.
                        <br />
                      </div>
                      <div className="text-size-body-2-cc is-opacity-64 mob-size-16">
                        Each client offer becomes a clean, professional landing page with photos,
                        layouts, pricing, and investment insights. All in one place
                      </div>
                    </div>
                  </div>
              ...
              <div className="container-main-cc">
                <div className="w-layout-grid features_cc_content-layout">
                  <div className="features_cc_content agent-page">
                    ...
                    <div>
                      <div className="text-size-body-2-cc is-opacity-64 mb-8 mob-size-16">
                        Each project includes a full set of investment metrics: ROI, IRR, Cap Rate,
                        and more.
                        <br />
                      </div>
                      <div className="text-size-body-2-cc is-opacity-64 mob-size-16">
                        You’ll also see details on nearby infrastructure, live pricing, and unit
                        availability. Always fresh, always relevant
                      </div>
                    </div>
                  </div>
                  <div className="features_cc_image-wrapper agent-page">
                    ...
                    <div className="div-block-55">
                      <div className="div-block-56">
                        <div className="div-block-58">
                          <div className="text-size-body-2-cc is-opacity-64">Object price</div>
                          <div className="heading-style-h7-cc">$114,215</div>
                        </div>
                        <div className="div-block-58">
                          <div className="text-size-body-2-cc is-opacity-64">Delivery date</div>
          ...
          <section id="why-thailand" data-theme="light" className="section_cc_reveal agent-page">
            <div className="container-main-cc">
              <div className="w-layout-grid reveal_cc_content-layout">
                ...
                >
                  <div>
                    <div className="heading-style-h7-cc mb-8">Your Clients Stay Yours</div>
                    <p className="text-size-body-3-cc">Privacy guaranteed. 100%. Always</p>
                  </div>
                  <div>
                    <div className="text-size-body-2-cc is-opacity-64-black mb-8 mob-size-16">
                      Your client base is yours and it stays that way.
                      <br />
                      We never ask for contact details unless you choose to involve us.
                      <br />
                    </div>
                    <div className="text-size-body-2-cc is-opacity-64-black mob-size-16">
                      If you need help closing a deal, you can explicitly invite us in. Until then,
                      your client data remains fully under your control.
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="features_cc_content partner-instrument agent-pag">
                ...
                <div className="div-block-59">
                  <div className="div-block-60">
                    ...
                    <div className="text-size-body-2-cc mob-size-16">No credit card needed</div>
                  </div>
                  <div className="div-block-60">
                    <div className="code-embed-4 w-embed">
                      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="text-size-body-2-cc mob-size-16">Cancel anytime</div>
                  </div>
                  <div className="div-block-60">
                    <div className="code-embed-4 w-embed">
                      <svg
                    ...
                    <div className="text-size-body-2-cc mob-size-16">Free while beta is open</div>
                  </div>
                </div>
                <a
              ...
              <div className="footer_layout">
                ...
                <div className="footer_text">
                  <div className="text-size-caption-cc is-opacity-64">
                    The information provided in this material is for informational purposes only and
                    does not represent the official position or endorsement of any developer or
                    project mentioned herein.
                    <br />
                    Project ratings and scores — including those related to potential returns,
                    investment attractiveness, and risk — are based on the internal evaluation
                    methodology of Insight Realty Co., Ltd. These assessments reflect the subjective
                    opinions of our team and are derived from publicly available information at the
                    time of publication.
                    <br />
                    Insight Realty Co., Ltd. does not provide financial advice or investment
                    consulting services, and makes no guarantees regarding the achievement of any
                    specific financial results or performance indicators.Insight Realty Co., Ltd.
                    shall not be held liable for any decisions made based on the information or
              ...
              <div className="container-large">
                <div className="footer_row">
                  <div className="text-size-body-2-cc">
                    © 2025 Lots Of Properties. All rights reserved.
                  </div>
                </div>
              </div>
            </div>
