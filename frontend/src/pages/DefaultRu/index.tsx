              ...
              <div className="footer_layout">
                ...
                <div className="footer_text">
                  <div className="text-size-caption-cc is-opacity-64">
                    ...
                    соответствующими застройщиками по их собственному усмотрению. Insight Estate
                    действует как независимый посредник и не является официальным представителем или
                    агентом по продажам какого-либо застройщика. Insight Estate не несёт
              ...
              <div className="container-large">
                <div className="footer_row">
                  <div className="text-size-body-2-cc">
                    © <span data-year-footer="">2025</span> Insight Estate. Все права защищены.
                  </div>
                </div>
              </div>
            </div>
