...
import styles from './EstateDetailV2.module.scss';
...
import { detailApi, EstateDetail } from '@/widgets/Detail/api/detailApi';
...
const EstateDetailV2: FC = () => {
  ...
  const [estateDetailData, setEstateDetailData] = useState<EstateDetail>();
  ...
  return <div>EstateDetailV2</div>;
};

export default EstateDetailV2;
